...
class PledgesControllerTest < ActionController::TestCase
  ...
  test "should create pledge" do
    assert_difference('Pledge.count') do
      post :create, pledge: { amount: @pledge.amount, issue_title: @pledge.issue_title, issue_url: @pledge.issue_url, string: @pledge.string }
    end
  ...
  test "should update pledge" do
    put :update, id: @pledge, pledge: { amount: @pledge.amount, issue_title: @pledge.issue_title, issue_url: @pledge.issue_url, string: @pledge.string }
    assert_redirected_to pledge_path(assigns(:pledge))
  end
